...
db.Expence = require("./expense")(sequelize, Sequelize.DataTypes);
db.ExpensePayment = require("./expense-payment")(sequelize, Sequelize.DataTypes);
...
db.TripBooking = require("./trip-booking")(sequelize, Sequelize.DataTypes);
